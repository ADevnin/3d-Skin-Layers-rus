    ...
    public void render(ModelPart vanillaModel, PoseStack poseStack, VertexConsumer vertexConsumer, int light,
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Crash in 3d Skin Layer function from overflow. https://github.com/tr7zw/3d-Skin-Layers/issues/280 PolgyonAmount="
                            + polygonAmount + " PolygonDataLength=" + polygonData.length,
                    ex);
        }
